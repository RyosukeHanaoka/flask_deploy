...
@edit_blueprint.route('/symptom/<string:object_id>', methods=['GET', 'POST'])
@login_required
def symptom(object_id):
    ...
    return render_template('symptom.html', symptom_data=symptom_data, years=years, months=months, days=days, stiffness_durations=stiffness_durations)

@edit_blueprint.route('/righthand/<string:object_id>', methods=['GET', 'POST'])
@login_required
def righthand(object_id):
    ...
    return render_template('righthand.html', right_hand_data=right_hand_data)

@edit_blueprint.route('/lefthand/<string:object_id>', methods=['GET', 'POST'])
@login_required
def lefthand(object_id):
    ...
    return render_template('lefthand.html', left_hand_data=left_hand_data)

@edit_blueprint.route('/body/<string:object_id>', methods=['GET', 'POST'])
@login_required
def body(object_id):
...
@edit_blueprint.route('/foot/<string:object_id>', methods=['GET', 'POST'])
@login_required
def foot(object_id):
...
@edit_blueprint.route('/labo_exam/<string:object_id>', methods=['GET', 'POST'])
@login_required
def labo_exam(object_id):
    ...
    return render_template('labo_exam.html', criteria_data=criteria_data)

@edit_blueprint.route('/handpicture/<string:object_id>', methods=['GET', 'POST'])
@login_required
def handpicture(object_id):
    ...
    return render_template('handpicture.html', hand_data=hand_data)
